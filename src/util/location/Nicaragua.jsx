const Nicaragua = [
    {
        ...
        label: (
            <div className="d-flex align-items-center">
                <img
                    src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/71/Seal_of_Boaco.svg/29px-Seal_of_Boaco.svg.png"
                    alt="Boaco"
    ...
    },
    {
        ...
        label: (
            <div className="d-flex align-items-center">
                <img
                    src="https://upload.wikimedia.org/wikipedia/commons/6/65/Escudo_de_Villanueva_de_Carazo.svg"
                    alt="Carazo"
                    style={{ width: "30px", height: "30px", marginRight: "8px" }}
                />
               Carazo
    ...
    },
    {
        ...
        label: (
            <div className="d-flex align-items-center">
                <img
                    src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Escudo_de_Chinandega.svg/45px-Escudo_de_Chinandega.svg.png"
                    alt="Chinandega"
                    style={{ width: "30px", height: "30px", marginRight: "8px" }}
                />
               Chinandega
    ...
    },
    {
        ...
        label: (
            <div className="d-flex align-items-center">
                <img
                    src="https://www.bravosdechontales.com/wp-content/uploads/2020/12/Logo-full.png"
                    alt="Chontales"
                    style={{ width: "30px", height: "30px", marginRight: "8px" }}
                />
                Chontales
