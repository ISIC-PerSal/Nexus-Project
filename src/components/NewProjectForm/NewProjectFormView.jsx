...
function NewProjectFormView({ValidarDatos}) {
  const longText = `¿Por qué preguntamos esto?: 
  Para tener un seguimiento seguro de donativos financieros en temas legales, solicitamos este tipo de datos a nuestros usuarios. No se comparten con nadie más`;
  const ods = [
    {
      ...
      <main className="py-3">
        ...
        >
          <div className="mb-3">
            ...
            <div className="mb-3">
              <label htmlFor="tipo-lider" class="form-label">
                Representante
              </label>
            ...
            <div className="mb-3">
              <label htmlFor="RFC-lider" className="form-label">
                RFC
              </label>
          ...
          <button onClick={ValidarDatos} type="button" class="btn btn-danger w-100">
            Enviar datos
          </button>
        </form>
      </main>
