...
function NewProjectFormView({validarDatos, nombreLider, setNombreLider}) {
    const longText = `
"¿Por qué preguntamos esto?": Para tener un seguimiento seguro de donativos financieros 
en temas legales, solicitamos este tipo de datos a nuestros usuarios. No se comparten con nadie más.
`;
    const ods = [
        {
                ...
                <form action="" className='container w-50 mt-3 p-3 border rounded border-secondary-subtle bg-gral'>
                    <div className="mb-3">
                        ...
                        <div className="mb-3">
                            ...
                            <input value={nombreLider} type="text" className="form-control" id="nombre-lider"></input>
                        </div>
                        <div className="mb-3">
                        ...
                        <div className="mb-3">
                            ...
                            <input type="email" className="form-control" id="correo-lider" required></input>
                        </div>
                        <div className="mb-3">
                                    ...
                                    ods.map((item, index) => (
                                        <Grid item xs={3}>
                                            <div key={index} className="form-check">
                                                ...
                                                <label className="form-check-label" for={`ods${item.ods}`}>
