    ...
    if (
      ...
      if (leaderType== 0) {
        Swal.fire({
          position: "top-end",
          icon: "info",
          title: "Seleccione una opcion para el tipo de representante",
        ...
        Swal.fire({
          position: "top-end",
          icon: "info",
          title: "Verifique los datos del correo del libder o representante",
          showConfirmButton: false,
          timer: 1500,
        });
        ...
        Swal.fire({
          position: "top-end",
          icon: "info",
          title: "El numero de voluntarios no acepta numeros negativos",
          showConfirmButton: false,
          timer: 1000,
        });
        ...
        Swal.fire({
          position: "top-end",
          icon: "info",
          title: "La descripcion del proyecto no puede estar vacia",
          showConfirmButton: false,
          timer: 1000,
        });
      } else if (typeProject== 0) {
        Swal.fire({
          position: "top-end",
          icon: "info",
          title: "Seleccione una opcion para el tipo de proyecto",
          showConfirmButton: false,
          timer: 1500,
        });
