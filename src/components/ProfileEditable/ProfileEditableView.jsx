...
function ProfileEditableView({ name, setName, lastName, setlastName, email, setEmail, birthday, setBirthday, password, setPassword, rfc, setRfc, clabe, setClabe, updateUser }) {
    ...
    return (
        <>
            ...
            >
                ...
                <div className="mb-3">
                    <label htmlFor="lastNameUser" class="form-label">
                        Apellidos
                    </label>
                    <input type="text" className="form-control" id="lastNameUser"
                        value={lastName}
                ...
                <div class="mb-3">
                    ...
                    <input disabled={true} type="date" class="form-control" id="birthdayUser"
                        value={birthday}
                ...
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control" id="rfcUser"
                    value={rfc}
                ...
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control" id="clabeUser"
                    value={clabe}
                    onChange={(e) => setClabe(e.target.value)}
                    ></input>
                </div>
                <input onClick={updateUser} class="btn btn-primary w-100" type="submit" value="Guardar datos"></input>
            </form>
        </>
    )
}
