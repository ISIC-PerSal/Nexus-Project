...
function ProfileEditableView({ name, setName, lastName,
    setLastName,
    email,
    setEmail,
    birthday,
    ...
    return (
        <>
            <form action="" className="container w-50 mt-3 p-3 border rounded border-secondary-subtle bg-gral ms-4">
                <div>
                    <h2>
                        Editar perfil {" "}
                ...
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control" id="lastNameUser" value={lastName} onChange={(e) => setLastName(e.target.value)}></input>
                </div>
                <div className="mb-3">
                    <label htmlFor="emailUser" className="form-label">
                        Correo
                    </label>
                    <input type="email" className="form-control" id="emailUser" value={email} onChange={(e) => setEmail(e.target.value)}></input>
                </div>
                <div className="mb-3">
                    <label htmlFor="birthdayUser" className="form-label">
                        Fecha de Nacimiento
                    </label>
                    <input disabled={true} type="date" className="form-control" id="birthdayUser" value={birthday} onChange={(e) => setBirthday(e.target.value)}></input>
                </div>
                <div className="mb-3">
                    <label htmlFor="passwordUser" className="form-label">
                        Contraseña
                    </label>
                    <input type="text" className="form-control" id="passwordUser" value={password} onChange={(e) => setPassword(e.target.value)}></input>
                </div>
                <div className="mb-3">
