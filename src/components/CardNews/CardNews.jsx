...
function CardNews({ item }) {
  const getStatusIcon = (status) => {
    switch (status) {
      case "Privado":
        return <span className="badge bg-azul-1 ms-1">
          <div className="d-flex align-items-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-file-earmark-lock2" viewBox="0 0 16 16">
      ...
      case "Miembros":
        return <span className="badge bg-azul-2 ms-1">
          <div className="d-flex align-items-center">
      ...
      default:
        return <span className="badge bg-azul-3 ms-1">
          <div className="d-flex align-items-center">
