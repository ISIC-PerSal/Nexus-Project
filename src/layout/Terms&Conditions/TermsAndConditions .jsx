  ...
  return (
    <>
      ...
      <div className="container w-75 mt-3 p-3 mb-3 border rounded border-secondary-subtle bg-gral">
        ...
        <p> Estos términos y condiciones describen las reglas y regulaciones para el uso del sitio web de Nexus Project, ubicado en  http://nexus-project.ct.ws/.</p>
        <p> Al acceder a este sitio web, asumimos que aceptas estos términos y condiciones. No continúes usando Nexus Project <b>si no estás de acuerdo</b> con todos los términos y condiciones establecidos en esta página.</p>
        <h2>Cookies</h2>
        El sitio web utiliza cookies para ayudar a personalizar tu experiencia en línea. Al acceder a Nexus Project, aceptaste utilizar las cookies necesarias.
        ...
        Podemos utilizar cookies para recopilar, almacenar y rastrear información con fines estadísticos o de marketing para operar nuestro sitio web. Tienes la capacidad de aceptar o rechazar cookies opcionales. Hay algunas cookies obligatorias que son necesarias para el funcionamiento de nuestro sitio web. Estas cookies no requieren tu consentimiento ya que siempre funcionan.<p>Ten en cuenta que al aceptar las cookies requeridas, también aceptas las cookies de terceros, que podrían usarse a través de servicios proporcionados por terceros si utilizas dichos servicios en nuestro sitio web, por ejemplo, una ventana de visualización de video proporcionada por terceros e integrada en nuestro sitio web.</p>
        <h2>Licencia</h2>
        <p>A menos que se indique lo contrario, Nexus Project y/o sus licenciantes poseen los derechos de propiedad intelectual de todo el material en Nexus Project. Todos los derechos de propiedad intelectual son reservados. Puedes acceder desde Nexus Project para tu uso personal sujeto a las restricciones establecidas en estos términos y condiciones.
          <b>No</b> debes:</p>:
        <ul>
          <li><p>• Copiar o volver a publicar material de Nexus Project</p></li>
          <li><p>• Vender, alquilar o sublicenciar material de Nexus Project</p></li>
          <li><p>• Reproducir, duplicar o copiar material de Nexus Project</p></li>
          <li><p>• Redistribuir contenido de Nexus Project</p></li>
        </ul>
        Este acuerdo comenzará el 29 de noviembre del 2024.
        Partes de este sitio web ofrecen a los usuarios la oportunidad de publicar e intercambiar opiniones e información en determinadas áreas. Nexus Project no filtra, edita, publica ni revisa los comentarios antes de su presencia en el sitio web. <b>Los comentarios no reflejan los puntos de vista ni las opiniones de Nexus Project</b>, sus agentes y/o afiliados. Los comentarios <b>reflejan los puntos de vista y opiniones de la persona que publica</b>.
        <br></br>
        <br></br>
        <p>En la medida en que lo permitan las leyes aplicables, Nexus Project no será responsable de los comentarios ni de ninguna responsabilidad, daños o gastos causados o sufridos como resultado de cualquier uso o publicación o apariencia de comentarios en este sitio web.
          Nexus Project se reserva el derecho de monitorear todos los comentarios y eliminar los que puedan considerarse inapropiados, ofensivos o que incumplan estos Términos y Condiciones.
          Garantizas y declaras que:</p>
        <ul>
          <li><p>•	Tienes derecho a publicar comentarios en nuestro sitio web y tienes todas las licencias y consentimientos necesarios para hacerlo;</p></li>
          <li><p>•	Los comentarios no invaden ningún derecho de propiedad intelectual, incluidos, entre otros, los derechos de autor, patentes o marcas comerciales de terceros;</p></li>
          <li><p>•	Los comentarios no contienen ningún material difamatorio, calumnioso, ofensivo, indecente o ilegal de otro modo, que sea una invasión de la privacidad.</p></li>
          <li><p>•	Los comentarios no se utilizarán para solicitar o promover negocios o actividades comerciales personalizadas o presentes o actividades ilegales.</p></li>
          <li><p>•	Por la presente, otorgas a Nexus Project una licencia no exclusiva para usar, reproducir, editar y autorizar a otros a usar, reproducir y editar cualquiera de tus comentarios en todas y cada una de las formas, formatos, o medios.</p></li>
        </ul>

        <h2>Recopilación y uso de sus datos personales</h2>
        <h3>Tipos de datos recopilados</h3>
        <h4>Datos Personales</h4>
        <p>Mientras utilices nuestro servicio, podemos pedirte que nos proporciones cierta información de identificación personal que pueda usarse para contactarlo o identificarlo. La información de identificación personal puede incluir, entre otros:</p>
        <ul>
          <li>
        ...
        <ul>
          ...
          <li>
            <p>•	Organizaciones de noticias;</p></li>
          <li>
        ...
        <p>Estas organizaciones pueden enlazar a nuestra página de inicio, a publicaciones o a otra información del sitio siempre que el enlace: (a) no sea engañoso de ninguna manera; (b) no implique falsamente patrocinio, respaldo o aprobación de la parte vinculante y sus productos y/o servicios; y (c) encaja en el contexto del sitio de la parte vinculante.
          Podemos considerar y aprobar otras solicitudes de enlaces de los siguientes tipos de organizaciones:</p>
        <ul>
          <li><p>•	Fuentes de información de consumidores y/o empresas comúnmente conocidas;</p></li>
          <li><p>•	Sitios de la comunidad .com;</p></li>
          <li><p>•	Asociaciones u otros grupos que representan organizaciones benéficas;</p></li>
          <li><p>•	Distribuidores de directorios en línea;</p></li>
          <li><p>•	Portales de Internet;</p></li>
          <li><p>•	Firmas de contabilidad, derecho y consultoría; y</p></li>
          <li><p>•	Instituciones educativas y asociaciones comerciales.</p></li>
        </ul>
        <p>Aprobaremos las solicitudes de enlace de estas organizaciones si: (a) el enlace no nos haría vernos desfavorablemente a nosotros mismos ni a nuestras empresas acreditadas; (b) la organización no tiene registros negativos con nosotros; (c) el beneficio para nosotros de la visibilidad del hipervínculo compensa la ausencia de Nexus Project; y (d) el enlace está en el contexto de información general de recursos.</p>
        ...
        Si eres una de las organizaciones enumeradas en el párrafo 2 y estás interesada en vincularte a nuestro sitio web, debes informarnos enviando un correo electrónico a Nexus Project. Incluye tu nombre, el nombre de tu organización, la información de contacto, así como la URL de tu sitio, una lista de las URL desde las que tienes la intención de vincular a nuestro sitio web y una lista de las URL de nuestro sitio a las que te gustaría acceder. Espera 2-3 semanas para recibir una respuesta. 
   <p>Las organizaciones aprobadas pueden hacer hipervínculos a nuestro sitio web de la siguiente manera:</p>  
       <ul>
       <li><p>•	Mediante el uso de nuestro nombre corporativo; o</p></li> 
        ...
        No se permitirá el uso del logotipo de Nexus Project u otro material gráfico para vincular sin un acuerdo.
        ...
        <p>Si encuentras algún enlace en nuestro sitio que sea ofensivo por cualquier motivo, puedes contactarnos e informarnos en cualquier momento. Consideraremos las solicitudes para eliminar enlaces, pero no estamos obligados a hacerlo ni a responder directamente.
          No nos aseguramos de que la información de este sitio web sea correcta. No garantizamos su integridad o precisión, ni prometemos asegurarnos de que el sitio web permanezca disponible o que el material en el sitio se mantenga actualizado.</p>
        ...
        <ul>
          <li><p>• Limitará o excluirá nuestra responsabilidad o la tuya por muerte o lesiones personales;</p></li>
          <li><p>•	Limitará o excluirá nuestra responsabilidad o la tuya por fraude o tergiversación fraudulenta;</p></li>
          <li><p>•	Limitará cualquiera de nuestras responsabilidades o las tuyas de cualquier manera que no esté permitida por la ley aplicable; o</p></li>
          <li><p>•	Excluirá cualquiera de nuestras responsabilidades o las tuyas que no puedan estar excluidas según la ley aplicable.</p></li>
        </ul>
