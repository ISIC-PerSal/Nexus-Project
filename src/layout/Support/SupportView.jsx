          ...
          <div className="accordion" id="accordionExample">
            ...
            <div className="accordion-item">
              ...
              <div id="collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                <div className="accordion-body">
                  <p>
                    El formulario en <b style={{color : "#F272A"}}><a style={{decoration: "none"}} href='/new-project'>Registrar proyecto</a></b> se inclina a la inscripción de <b>iniciativas ciudadanas o proyectos comunitarios alineados con el desarrollo de la localidad, de la mano con el impulso al cumplimiento de las metas de los <a target='_blank' href='https://www.un.org/sustainabledevelopment/es/objetivos-de-desarrollo-sostenible/'>Objetivos de Desarrollo Sustentable</a></b>.
                    <br/><br/>
