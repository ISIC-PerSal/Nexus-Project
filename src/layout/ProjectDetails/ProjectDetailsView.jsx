  ...
  return (
    <>
      <div className="bg-white">
        <EnrollProject idProject={data.id_project_pk} idUser={data.id_user_fk} />
      </div>
          ...
          <div>
            ...
            <div className="d-flex bg-body-secondary">
              <div className="w-50 p-4">
                ...
                <div className="mb-2">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-signpost-fill me-2" viewBox="0 0 16 16">
