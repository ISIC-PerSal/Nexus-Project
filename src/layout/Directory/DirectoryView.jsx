                    ...
                    <div>
                        <div>
                            ...
                            <div className="d-flex flex-row mb-3">
                                ...
                                <div classNames="p-2">I</div>
                                <div classNamess="p-2">O</div>
                                <div classNamess="p-2">P</div>
                                <div classNamess="p-2">S</div>
                            </div>
                        </div>
                        <div>
                            <label className='w-100 p-1 fw-bold' style={{ backgroundColor: "#173567", color: 'white' }}>Filtrar por ODS</label>
                            <div className='d-flex flex-row mb-3 mt-2 justify-contet-between'>
                                {
                                    odsData.map((item, index) => (
                                        <Tooltip key={index} title={item.title}>
                                            <button type="button" className=" icono-ods fw-bold" style={{ backgroundColor: item.color }}>{item.ods}</button>
                                        </Tooltip>
                                    ))
                                }
                                <Tooltip title="Todos los ods">
                                    <button type="button" className=" icono-ods fw-bold" style={{ backgroundColor: "#C13B6C" }}>
