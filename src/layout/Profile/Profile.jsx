...
function Profile() {
  ...
  const validData = () => {
    ...
    if (name.trim() === "") {
      ...
      messageError = "Ingrese un apellido.";
      isValid = false;
    } else if (email.trim() === "") {
      messageError = "Ingrese un correo electrónico.";
      isValid = false;
    } else if (password.trim() === "") {
      messageError = "Ingrese una contraseña.";
      isValid = false;
    }
  ...
  async function updateUser(e) {
    e.preventDefault();
    const validation = validData();
    if (!validation.isValid) {
      Swal.fire({
        position: "top-end",
        icon: "info",
        title: validation.messageError,
